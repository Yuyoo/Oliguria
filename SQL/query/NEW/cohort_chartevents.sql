DROP MATERIALIZED VIEW IF EXISTS oliguria_cohort_chartevents CASCADE;
CREATE MATERIALIZED VIEW oliguria_cohort_chartevents AS
WITH base as (
SELECT obc.*,
...
and ce.charttime BETWEEN base.starttime and (base.starttime + INTERVAL '24' hour)
